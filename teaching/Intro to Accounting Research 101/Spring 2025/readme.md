    ...
    <nav class="feature-nav" aria-label="课程功能">
      ...
      <div class="feature-group">
        ...
        <div class="feature-subnav">
          ...
          <button type="button" data-feature="会计研究的哲学">会计研究的哲学</button>
        </div>
      </div>
      ...
      <div class="feature-group">
        ...
        <div class="feature-subnav">
          ...
          <button type="button" data-feature="研究贡献评估">研究贡献评估</button>
        </div>
      </div>
    ...
    <div class="conversation" data-chat-log aria-live="polite">
      <div class="welcome-block">
        ...
        <div class="starter-grid">
          ...
          <button type="button" data-prompt>帮我评估研究问题的效度</button>
          <button type="button" data-prompt>怎样判断一项研究的贡献？</button>
        </div>
      </div>
    </div>
